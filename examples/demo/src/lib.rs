...
use sshui::ratatui::widgets::ListState;
use sshui::{InputEvent, KeyCode, KeyEvent};
...
impl<'a> sshui::App for App<'a> {
    fn render(&mut self, terminal: &mut sshui::SSHUITerminal) -> anyhow::Result<Option<String>> {
    ...
    fn input(&mut self, event: InputEvent) {
        ...
        match key {
            KeyCode::Char('h') | KeyCode::LeftArrow => self.on_left(),
            KeyCode::Char('j') | KeyCode::DownArrow => self.on_down(),
            KeyCode::Char('k') | KeyCode::UpArrow => self.on_up(),
            KeyCode::Char('l') | KeyCode::RightArrow => self.on_right(),
            _ => {}
        }
    }
