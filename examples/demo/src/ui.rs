use sshui::ratatui::layout::{Constraint, Layout, Rect};
use sshui::ratatui::style::{Color, Modifier, Style};
use sshui::ratatui::text::{self, Span};
use sshui::ratatui::widgets::canvas::{self, Canvas, Circle, Map, MapResolution, Rectangle};
use sshui::ratatui::widgets::{
    Axis, BarChart, Block, Cell, Chart, Dataset, Gauge, LineGauge, List, ListItem, Paragraph, Row,
    Sparkline, Table, Tabs, Wrap,
};
use sshui::ratatui::{Frame, symbols};
